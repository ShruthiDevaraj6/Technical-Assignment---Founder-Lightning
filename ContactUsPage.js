...
class ContactPage{
    ...
    setFirstName(firstname)
    {
        ...
        cy.get(this.errormessage_fn).should('not.exist')
    }
    ...
    setLastName(lastname)
    {
        ...
        // Negative Assertion- Check that the error message for the mandatory field is not displayed- Please complete the required field
        cy.get(this.errormessage_ln).should('not.exist')
    ...
    setEmail(email)
    {
        ...
        cy.get(this.emailformaterror).should('not.exist')
        // Negative Assertion- Check that the error message for the mandatory field is not displayed- Please complete the required field
        cy.get(this.errormessage_email).should('not.exist')
    }
    ...
    setMobileNumber(number)
    {
        ...
        cy.get(this.mobilerrorformat).should('not.exist')
        // Negative Assertion- Check that the error message for the mandatory field is not displayed- Please complete the required field
        cy.get(this.errormessage_mob).should('not.exist')
    }
    ...
    setMessage(message){
        ...
        // Negative Assertion- Check that the error message for the mandatory field is not displayed- Please complete the required field
        cy.get(this.error_text).should('not.exist')
    }
